...
<body>
    ...
    <div class="py-12 bg-slate-300 text-center mt-[116px]">
        <a class="text-slate-500 mx-2" href="/">Trang chủ</a> / <span
            class="mx-2">Kết quả tìm kiếm "a" - ANKER Việt Nam</span>
    </div>

    <div class="px-[20vw] my-12">
        <h2 class="text-center font-bold text-[24px]">Tìm kiếm của bạn "a" tất
            cả kết quả:</h2>
        <div class="my-6 flex items-center justify-center">
            <input type="text"
                class="p-2 bg-gray-100 w-full h-[40px] outline-none border"
                value="a">
            <button class="bg-red-500 font-semibold text-white h-[40px] px-5"><i
                    class="fa-solid fa-magnifying-glass"></i></button>
        </div>
        <div class="grid grid-cols-4 mt-3 gap-2">
            <div class=" bg-white border border-gray-200 shadow ">
                <a href="./detail.html" class="relative group">
                    ...
                    <span
                        class="absolute top-[50%] translate-y-[-50%] text-center left-[50%] translate-x-[-50%] px-4 py-1 bg-red-400 text-[16px] font-bold text-white hidden group-hover:block">MUA
                        NHANH</span>
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
